...
public class DiscoveryFragment extends LazyFragment<FragmentDiscoveryHotBinding> {
    ...
    public void initViews() {
        super.initViews();
        binding.tvHeaderTitle.setText(UiUtils.getString(R.string.discovery));
    ...
    public void onFirstUserVisible() {
        ...
        Log.e("hello vm","DiscoveryFragment");
    }
}
